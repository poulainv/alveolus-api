...
//        bookmarks.ajax_get_by_website_id(popup.current_website_id,function(){
//            $(settings.bookmark_star).attr('src',"/img/star-on.png")
//            settings.bookmarked = true;
//        }), function(){
//            bookmarks.ajax_delete(popup.current_website_id, function(){
//                $(settings.bookmark_star).attr('src',"/img/star-off.png")
//                settings.bookmarked = false;
//            });
//        }
//    };
//
//    this.listenerBookmarkButton = (function (){
//      //  Listener
